...
export const noteDecentralizedNature = [
...
export const privacyAndDisputes = [
...
export const disputesInfoA = [
	'A Party to this Agreement claiming that a dispute ("the Dispute") has arisen under or in relation to this Agreement must give written notice to the other Party to this Agreement specifying the nature of the Dispute.',
	'On receipt of that notice by that other party, the Parties to this contract must endeavor in good faith to resolve the Dispute expeditiously using informal dispute resolution techniques such as mediation, expert evaluation or determination or similar techniques agreed to them.',
	'If the parties do not agree within ten (10) days of receipt of the notice (or such further period as agreed in writing by them) as to:',
]

export const disputeTime10DaysText = [
	'the dispute resolution technique and procedures to be adopted;',
	'the timetable for all steps in those procedures; and',
	'the selection and compensation of the independent person required for such technique; the dispute shall be submitted to mediation.'
]

export const disputesInfoB = [
	"A mediator will enable the parties to mediate and settle the dispute. All discussions in the mediation will be without prejudice and will not be referred to in any later proceedings. The Parties will bear their own costs in the mediation and will equally share the mediator's costs.",
	'If the dispute is not resolved under clause (C) within a further 30 days after the appointment of a mediator, any party may then require the dispute to be referred to arbitration. If this clause is invoked:'
]

export const disputeTime30DaysText = [
	'the arbitration will take place in the State of California;',
	'the award in the arbitration will be final and binding on the Parties; and',
