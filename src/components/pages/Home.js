      ...
      {loading === false ? (
        <div className='mainContainer homePage'>
          ...
          <div className='whatsbmc'>
            ...
            <h2>WHAT IS BMC?</h2>
            <p>
              Blockchain Miners NFTs are hand drawn rare and unique artworks. Our unique artworks
              are inspired by Bitcoin miners (Antminer S19j ASIC Pro) and will be limited to 11,111
              items that are generated from 280+ traits and attributes.
            </p>
            {!isdesktop ? (
          ...
          <div className='ultraMiners'>
            ...
            <div className='blkBox'>
              <p>
                <strong>BURNING</strong> is coming! On January 18th, 2022 you will be able to take
                ANY two OG Blockchain Miners Club NFTs and burn those items to mint an ULTRA MINER
              </p>
            </div>
          </div>
          ...
          <div className='hashToken'>
            ...
            <p>
              ...
              <strong>April 4th, 2022</strong>. BMC VENTURES INC. has dedicated 1,500,000 GH/s
